...
public class EditorConsole : EditorWindow {
    ...
    void OnEnable () {
        ...
        consoleModel.onNewMessage += (s => historyScroll.y = float.PositiveInfinity);
    ...
    void OnGUI() {
        ...
        if (showEditor) {
            ...
            editorCode = EditorGUILayout.TextArea (editorCode, GUILayout.MinHeight (position.height - 40));
        ...
        if(showLog) {
            ...
            Debug.Log (loggerModel.logs.Count);
